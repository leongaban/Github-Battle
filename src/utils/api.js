...
const errlog = (method, err) => console.warn(`%c${method}`, 'background: #393939; color: #F25A43', err);
...
function getRepos(username) {
	return axious.get(`https://api.github.com/users/${username}/repos${params}&per_page=100`)
